    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button className="rounded-full w-14 h-14 fixed bottom-4 right-4 bg-cyan-300 hover:bg-cyan-400 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] -translate-x-0.5 -translate-y-0.5 p-0 flex items-center justify-center">
        ...
        >
          ...
          <DropdownMenuItem asChild>
            <button className="flex items-center gap-3 w-full px-3 py-2 cursor-pointer hover:bg-blue-50 rounded justify-end">
              <span className="font-medium text-sm">Scan Budget</span>
